      ...
      >
        ...
        <div className="tw-w-full tw-rounded-3xl tw-border tw-border-zinc-800/80 tw-bg-zinc-900/60 tw-backdrop-blur-xl tw-p-8 md:tw-p-10 tw-shadow-[0_20px_50px_rgba(0,0,0,0.6)]">
          ...
          <form onSubmit={handleSubmit} className="tw-space-y-6">
            ...
            {/* Premium rounded off-white signup button */}
            <motion.button
              type="submit"
          ...
          <div className="tw-text-center tw-mt-8">
            <span className="tw-text-xs tw-text-zinc-550">Already have an account? </span>
            <Link to="/login" className="tw-text-xs tw-text-[#C084FC] hover:tw-text-purple-300 tw-font-semibold tw-no-underline">
              Sign In Instead
            </Link>
          </div>
