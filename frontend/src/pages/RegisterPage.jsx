      ...
      >
        ...
        <div className="tw-w-full tw-rounded-3xl tw-border tw-border-v-brown-dark/10 tw-bg-v-card tw-p-8 md:tw-p-10 tw-shadow-[0_12px_40px_rgba(107,62,46,0.06)]">
          ...
          <p className="tw-text-xs tw-text-v-text-sec tw-leading-relaxed tw-mb-8">
            Start your premium, personalized language learning journey elegantly today.
          </p>
            ...
            >
              {loading ? (
                ...
                <span className="tw-flex tw-items-center tw-gap-2">
                  Create Account <span className="tw-text-base">→</span>
                </span>
              )}
            </motion.button>
          </form>
          ...
          <div className="tw-text-center tw-mt-8">
            <span className="tw-text-xs tw-text-v-text-muted">Already have an account? </span>
            <Link to="/login" className="tw-text-xs tw-text-v-brown-dark hover:tw-text-v-brown-hover tw-font-semibold tw-no-underline">
              Sign In Instead
            </Link>
          </div>
